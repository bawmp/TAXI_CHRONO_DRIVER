// Tailles utilisées pour les paddings, sizedbox, bordures
...
class AppSizes {
  ...
  static const double pDesignAppBarWidth = 375;
  static const double pDesignAppBarHeight = 130;
  static const double pDesignHeight = 812;
}
...
const gapH18 = SizedBox(height: AppSizes.p18);
const gapH20 = SizedBox(height: AppSizes.p20);
const gapH25 = SizedBox(height: AppSizes.p25);
...
const gapW18 = SizedBox(width: AppSizes.p18);
const gapW20 = SizedBox(width: AppSizes.p20);
const gapW25 = SizedBox(width: AppSizes.p25);
const gapW30 = SizedBox(width: AppSizes.p30);
